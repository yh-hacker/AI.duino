...
自 **V2.8.0** 起，AI.duino 新增 NVIDIA BUILD 平台支持，可以选择 DeepSeek-V4-Pro 和 DeepSeek-V4-Flash 等模型。

自 **V2.8.1** 起，AI.duino 修复了本地提供商的 API 端点路径处理问题。现在同时支持带或不带 `/v1` 后缀的 URL。

自 **V2.8.2** 起，AI.duino 新增 DeepSeek 模型供应商支持，支持 DeepSeek V4 Pro 和 V4 Flash 模型。

> [!NOTE]
> Groq 不是 Grok！AI.duino 与 Elon Musk 无关！

🆕 What's new?  
* **23.07.2026** **Release V2.9.0**  为AI聊天增加了流式响应支持，AI Chat现在会在生成响应的同时逐步更新当前助手消息
* **22.07.2026** **Release V2.8.2** 新增 DeepSeek 模型供应商支持，支持 DeepSeek V4 Pro 和 V4 Flash 模型。  
* **22.07.2026** **Release V2.8.1** 修复了本地提供商的 API 端点路径处理问题，现在同时支持带或不带 `/v1` 后缀的 URL。  
* **22.07.2026** **Release V2.8.0** 新增 NVIDIA BUILD 平台支持，可以选择 DeepSeek-V4-Pro 和 DeepSeek-V4-Flash 等模型。包含 bug 修复。  
...
| **Cohere** | 🔥 | 命令系列模型 |
| **Groq** | 🚀 | 极快的推理速度，免费额度 |
| **NVIDIA BUILD** | 🟢 | 支持 DeepSeek-V4-Pro 和 DeepSeek-V4-Flash 模型 等更多模型 |
| **DeepSeek** | 🐳 | 国产高性能模型，支持 V4 系列 |
...
- DeepSeek: https://platform.deepseek.com (≥ V2.8.2)
